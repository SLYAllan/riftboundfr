...
export const EN_ARTICLES: Record<string, string> = {
  ...
  "Une partie en cours vue du dessus, avec l'overlay compact posé par-dessus.":
    "A game in progress seen from above, with the compact overlay laid over it.",
  ...
  "Le plateau vide avant le début de la partie, avec les deux Légendes et le score déjà affichés.":
    "The empty table before the game starts, with both Legends and the score already on screen.",
  "Le spectateur voit les deux decks avant le début de la partie.":
    "The viewer sees both decks before the game begins.",
  ...
  "Le compagnon de match sur une tablette posée à plat entre les deux joueurs, l'écran coupé en deux.":
    "The match companion on a tablet lying flat between the two players, the screen split in two.",
  ...
  "Un iPhone sur un petit trépied, qui filme le tapis avec l'overlay compact déjà en place.":
    "An iPhone on a small tripod, filming the playmat with the compact overlay already in place.",
  "Côté caméra, le montage tient dans un téléphone et un trépied.":
    "On the camera side, the setup fits into a phone and a tripod.",
  ...
  "Un petit trépied à poser au bord du tapis.":
    "A small tripod to place beside the playmat.",
  "Voir sur Amazon":
    "See on Amazon",
  ...
  "UGREEN, bras articulé magnétique":
    "UGREEN, magnetic articulated arm",
  "Se serre au bord de la table, tient le téléphone par aimant.":
    "Clamps to the table edge, holds the phone by magnet.",
};
