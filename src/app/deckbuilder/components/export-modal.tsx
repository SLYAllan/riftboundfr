          ...
          {activeTab === "link" && (
            <div className="space-y-4">
              ...
              {updateShareCode ? (
                <div className="border-t border-hairline pt-4 space-y-3">
                  ...
                  {updated ? (
                    ...
                    >{t("Deck mis à jour - voir la page du deck")}</a>
                  ) : (
                    <button
              ...
              <div className="border-t border-hairline pt-4">
                <label className="text-sm font-semibold text-ink-secondary">{t("Publier dans la communauté")}</label>

                {userLoading ? (
                  <p className="text-xs text-ink-muted mt-2">Chargement...</p>
                ) : !user ? (
                  <div className="mt-3">
                    <p className="text-xs text-ink-muted mb-3">{t("Connectez-vous avec Discord pour publier votre deck.")}</p>
                    <a
                    ...
                    >
                      ...
                      </svg>{t("Se connecter avec Discord")}</a>
                  </div>
                ) : (
                  <div className="mt-3 space-y-3">
                    ...
                    <label className="flex items-center gap-2 text-sm text-ink-secondary cursor-pointer">
                      ...
                      />{t("Non listé")}<span className="text-xs text-ink-muted">- accessible via lien uniquement</span>
                    </label>
            ...
            <div className="text-center py-6">
              ...
              {isAdmin && deckCode && (
                <div className="mt-5 border-t border-hairline pt-4">
                  <p className="text-xs text-ink-muted">{t("Formats réseaux, réservés à l’administration.")}</p>
