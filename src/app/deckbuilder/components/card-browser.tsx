...
export function CardBrowserV2({ cards, onAddCard, deckCardCounts, legendDomains, hasLegend, activeTab, legendFirstName }: CardBrowserProps) {
  ...
  const selectClass = "min-h-11 sm:min-h-8 sm:h-8 rounded-lg border border-hairline-strong bg-surface px-2.5 text-xs text-ink focus:border-arcane cursor-pointer";
