...
export function CardDetailModal({ card, onClose }: CardDetailModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-canvas/80 backdrop-blur-sm p-4" onClick={onClose}>
      <div ref={dialogRef} role="dialog" aria-modal="true" aria-labelledby="card-modal-title" tabIndex={-1} className="w-full max-w-2xl max-h-[85dvh] overflow-y-auto rounded-card border border-hairline bg-surface" onClick={(e) => e.stopPropagation()}>
