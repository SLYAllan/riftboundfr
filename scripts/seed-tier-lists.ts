...
// Recalculé sur 6906 decks classés Unleashed (S3 City Challenges + Xi'an/Tianjin/Changsha RO + Suzhou RQ + Sydney + Vancouver + Utrecht) — le méta le plus ouvert à ce jour.
...
const unleashedTier: TierEntry[] = [
  { legendName: "Master Yi, Wuju Bladesman", tier: "S", comment: "10,8% (744 decks), 46 top 8, 6 wins. #1 du field, Hold Body/Calm. A gagné Tianjin, 3e Vancouver, top 8 Utrecht" },
  { legendName: "Irelia, Blade Dancer", tier: "S", comment: "8,7% (601 decks), 37 top 8, 6 wins. T1 absolu, tempo gear" },
  { legendName: "Diana, Scorn of the Moon", tier: "S", comment: "6,3% (436 decks), 24 top 8, 2 wins. A gagné Vancouver (AlanZQ), 2e Tianjin, top 4 Utrecht" },
  { legendName: "LeBlanc, Deceiver", tier: "S", comment: "~6,3% (438 decks), 18 top 8, 2 wins. Deathknell midrange" },
  ...
  { legendName: "Azir, Emperor of the Sands", tier: "A", comment: "3,5% (242 decks), 8 top 8, 2 wins. A gagné Utrecht (Squirtle). Tokens equip" },
  ...
  { legendName: "Annie, Dark Child", tier: "A", comment: "1,7% (115 decks) mais 7 top 8 + 3 wins — meilleure conversion, sleeper" },
  ...
  { legendName: "Pyke, Bloodharbor Ripper", tier: "B", comment: "1,8% (126 decks), 4 top 8. 4e à Tianjin. Assassin" },
  { legendName: "Ezreal, Prodigal Explorer", tier: "B", comment: "1,6% (112 decks), 5 top 8" },
  ...
  { legendName: "Lux, Lady of Luminosity", tier: "D", comment: "0,9% (65 decks), 0 top 8" },
