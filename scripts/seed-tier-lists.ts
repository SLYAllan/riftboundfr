...
const vendettaTier: TierEntry[] = [
  { legendName: "Kai'Sa, Daughter of the Void", tier: "S", comment: "Le deck le plus joué du format, et il gagne." },
  { legendName: "Master Yi, Wuju Bladesman", tier: "S", comment: "Le plus régulier en Top 8, meilleure conversion du haut de tableau." },
  { legendName: "Kennen, Heart of the Tempest", tier: "S", comment: "Omniprésent et constant au sommet." },
  { legendName: "Irelia, Blade Dancer", tier: "A", comment: "Pilier de contrôle, forte présence." },
  { legendName: "Rek'Sai, Void Burrower", tier: "A", comment: "Convertit bien pour sa part, souvent en Top 8." },
  { legendName: "Diana, Scorn of the Moon", tier: "A", comment: "Valeur sûre du contrôle, plusieurs titres." },
  { legendName: "Nasus, Curator of the Sands", tier: "A", comment: "Présence solide et un titre." },
  { legendName: "Draven, Glorious Executioner", tier: "A", comment: "Peu joué mais l'une des meilleures conversions, et il gagne." },
  { legendName: "Jayce, Defender of Tomorrow", tier: "B", comment: "Beaucoup joué, mais passe peu le cap du Top 8." },
  { legendName: "Akali, Rogue Assassin", tier: "B", comment: "Bien représenté, en attente d'un vrai résultat." },
  { legendName: "Fiora, Grand Duelist", tier: "B", comment: "Le duel bien piloté paie : vainqueur à Nanjing." },
  { legendName: "Viktor, Herald of the Arcane", tier: "B", comment: "Contrôle Esprit, résultats ponctuels." },
  { legendName: "Ezreal, Prodigal Explorer", tier: "B", comment: "Petit échantillon, mais bonne conversion." },
  { legendName: "Lillia, Bashful Bloom", tier: "B", comment: "Régulière en Top 8 pour sa part." },
  { legendName: "Azir, Emperor of the Sands", tier: "B", comment: "Présence stable, quelques Top 8." },
  { legendName: "Rengar, Pridestalker", tier: "B", comment: "Peu joué mais capable de tout gagner." },
  { legendName: "Vex, Gloomist", tier: "B", comment: "Outil de verrou, pointe le nez en Top 8." },
  { legendName: "Ornn, Fire Below the Mountain", tier: "B", comment: "Présence modérée, un Top 8." },
  { legendName: "LeBlanc, Deceiver", tier: "B", comment: "Value et combo, résultats ponctuels." },
  { legendName: "Mel, Soul's Reflection", tier: "C", comment: "Présente sans encore percer." },
  { legendName: "Pyke, Bloodharbor Ripper", tier: "C", comment: "Jouable, discret ces derniers tournois." },
  { legendName: "Zed, Master of Shadows", tier: "C", comment: "Présence marginale." },
  { legendName: "Kha'Zix, Voidreaver", tier: "C", comment: "Présence marginale." },
  { legendName: "Jax, Grandmaster At Arms", tier: "C", comment: "Présence marginale." },
  { legendName: "Rumble, Mechanized Menace", tier: "C", comment: "Présence marginale." },
  { legendName: "Shen, Eye of Twilight", tier: "C", comment: "Présence marginale." },
  { legendName: "Sivir, Battle Mistress", tier: "C", comment: "Anecdotique, un éclair en Top 8." },
  { legendName: "Lux, Lady of Luminosity", tier: "C", comment: "Anecdotique, un éclair en Top 8." },
  { legendName: "Ambessa, Matriarch of War", tier: "C", comment: "Anecdotique, un éclair en Top 8." },
  { legendName: "Volibear, Relentless Storm", tier: "D", comment: "Anecdotique, échantillon minuscule." },
  { legendName: "Leona, Radiant Dawn", tier: "D", comment: "Anecdotique." },
  { legendName: "Master Yi, Wuju Master", tier: "D", comment: "Anecdotique, à ne pas confondre avec le Bladesman." },
  { legendName: "Sett, The Boss", tier: "D", comment: "Anecdotique." },
  { legendName: "Jhin, Virtuoso", tier: "D", comment: "Anecdotique." },
  { legendName: "Annie, Dark Child", tier: "D", comment: "Anecdotique." },
  { legendName: "Teemo, Swift Scout", tier: "D", comment: "Anecdotique." },
  { legendName: "Vi, Piltover Enforcer", tier: "D", comment: "Anecdotique." },
  { legendName: "Ivern, Green Father", tier: "D", comment: "Anecdotique." },
  { legendName: "Lucian, Purifier", tier: "D", comment: "Anecdotique." },
  { legendName: "Renekton, Butcher of the Sands", tier: "D", comment: "Anecdotique." },
  { legendName: "Darius, Hand of Noxus", tier: "D", comment: "Anecdotique." },
  { legendName: "Jinx, Loose Cannon", tier: "D", comment: "Anecdotique." },
  { legendName: "Renata Glasc, Chem-Baroness", tier: "D", comment: "Anecdotique." },
  { legendName: "Yasuo, Unforgiven", tier: "D", comment: "Anecdotique." },
  { legendName: "Ahri, Nine-Tailed Fox", tier: "D", comment: "Anecdotique." },
];
