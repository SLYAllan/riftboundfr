...
const vendettaTier: TierEntry[] = [
  ...
  { legendName: "Rengar, Pridestalker", tier: "B", comment: "Peu joué, mais il a gagné Ottawa." },
  { legendName: "LeBlanc, Deceiver", tier: "B", comment: "Value et combo, deux Top 8 sans titre." },
  { legendName: "Jayce, Defender of Tomorrow", tier: "B", comment: "72 listes pour 3 Top 8 : très joué, rarement récompensé." },
  { legendName: "Viktor, Herald of the Arcane", tier: "B", comment: "Contrôle Esprit, deux Top 8 en douze tournois." },
  { legendName: "Vex, Gloomist", tier: "B", comment: "Outil de verrou, pointe le nez en Top 8." },
  { legendName: "Kha'Zix, Voidreaver", tier: "C", comment: "Marginal, un Top 8 sur treize tournois." },
  ...
  { legendName: "Akali, Rogue Assassin", tier: "C", comment: "74 listes, quinze tournois, zéro Top 8 : le plus gros volume sans résultat du set." },
  { legendName: "Mel, Soul's Reflection", tier: "C", comment: "37 listes, aucun Top 8." },
  { legendName: "Pyke, Bloodharbor Ripper", tier: "C", comment: "Jouable, aucun Top 8 sur le corpus." },
  { legendName: "Zed, Master of Shadows", tier: "C", comment: "Présence marginale, aucun Top 8." },
  ...
  { legendName: "Leona, Radiant Dawn", tier: "C", comment: "Présence marginale." },
  { legendName: "Volibear, Relentless Storm", tier: "D", comment: "Échantillon minuscule, un Top 8 sur six listes." },
  ...
  { legendName: "Miss Fortune, Bounty Hunter", tier: "D", comment: "Anecdotique." },
  { legendName: "Poppy, Keeper of the Hammer", tier: "D", comment: "Une seule liste sur tout le corpus." },
];
