...
### Cores observés — corpus Vendetta à jour (17 août 2026, 1671 decklists)
...
- **Kennen, Heart of the Tempest** (162 listes) — core : Lightning Rush 3x (100 %), Stacked Deck 3x (98 %), Fizz, Trickster 2x (91 %), Star-Crossed 2x (90 %). Standard : Ride the Wind 2x (89 %), Rhasa the Sunderer 3x (87 %), Seal of Discord 3x (85 %), Traveling Merchant 3x (83 %), Last Rites 2x (81 %), Nocturne, Horrifying 3x (75 %), Treasure Hunter 3x (67 %).
...
- **Draven, Glorious Executioner** (51 listes) — core : Spinning Axe 3x (100 %), Tideturner 2x (98 %), Stacked Deck 3x (98 %), Switcheroo 2x (96 %), Kai'Sa, Survivor 2x (94 %), Rebuke 2x (90 %), Ride the Wind 2x (90 %). Standard : Vex, Apathetic 3x (88 %), Falling Star 2x (88 %), Cleave 1x (88 %), Ferrous Forerunner 2x (86 %), Overzealous Fan 2x (82 %), Perfect Execution 1x (80 %), Gust Monk 2x (75 %), Evelynn, Entrancing 3x (73 %), Brynhir Thundersong 1x (65 %), Kha'Zix, Mutating Horror 1x (65 %), Edge of Night 2x (65 %), Pyke, Returned 2x (63 %).
