...
**Lire ensuite.** `AGENTS.md` (règles + architecture, commandes, conventions — source unique, lue aussi par Codex) · `HANDOFF.md` (état, chantier en cours, pièges) · `docs/PROJET.md` (tout le projet) · `.hermes/SKILLS.md` (quel skill sert à quoi ici ; toute prose FR rendue passe par la commande `reecrire`).
